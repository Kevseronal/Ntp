...
namespace NtpAutomation
{
    public partial class SignUp : Form
    {
        ...
        private void btnSignUp2_MouseHover(object sender, EventArgs e)
        {
            btnSignUp2.BackColor = Color.Cyan;
        }

        private void btnSignUp2_MouseLeave(object sender, EventArgs e)
        {
            btnSignUp2.BackColor = Color.LightSeaGreen;
        }
